...
var renderText = function renderText(message, styles) {
  if (styles) {
    markdownStyles = _objectSpread$1({}, markdownStyles, {}, styles);
    ...
    value: function render() {
      switch (this.props.listType) {
        case 'channel':
          ...
          }, React__default.createElement(Spinner, null), React__default.createElement(LoadingText, null, "Loading channels ..."));
        ...
        case 'message':
          ...
          }, React__default.createElement(Spinner, null), React__default.createElement(LoadingText, null, "Loading messages ..."));
        ...
        default:
          ...
          }, React__default.createElement(Spinner, null), React__default.createElement(LoadingText, null, "Loading ..."));
      }
    }
  }]);
...
var Channel = withChatContext((_temp$4 = _class$4 =
/*#__PURE__*/
function (_PureComponent) {
   ...
   * */
  Attachment: PropTypes.oneOfType([PropTypes.node, PropTypes.func])
}), _defineProperty(_class$4, "defaultProps", {// LoadingIndicator,
...
var Footer = styled__default.View(_templateObject2$4(), function (_ref5) {
  var alignment = _ref5.alignment,
      theme = _ref5.theme;
  return alignment === 'right' ? '0' : 'solid 1px white';
}, function (_ref6) {
  var alignment = _ref6.alignment,
      theme = _ref6.theme;
  return alignment === 'right' ? theme.colors.primary : 'transparent';
}, function (_ref7) {
  var theme = _ref7.theme;
  return theme.message.card.footer.css;
});
var Cover = styled__default.Image(_templateObject3$3(), function (_ref8) {
  var theme = _ref8.theme;
  return theme.message.card.cover.css;
});
var StyledText = styled__default.Text(_templateObject4$2(), function (_ref9) {
  var alignment = _ref9.alignment,
      theme = _ref9.theme;
  return alignment === 'right' ? 'black' : 'white';
});
/**
...
var Card = withMessageContentContext(themed((_temp$5 = _class$5 =
/*#__PURE__*/
function (_React$Component) {
  ...
  _createClass(Card, [{
    ...
    value: function render() {
      ...
      }, title && React__default.createElement(StyledText, {
        alignment: alignment
      }, title), text && React__default.createElement(StyledText, {
        alignment: alignment
      }, text), React__default.createElement(StyledText, {
        alignment: alignment
      }, this.trimUrl(title_link || og_scrape_url))), type === 'giphy' && React__default.createElement(reactNative.Image, {
        source: img
      })));
    }
  }]);
  ...
  return Card;
}(React__default.Component), _defineProperty(_class$5, "themePath", 'card'), _defineProperty(_class$5, "propTypes", {
...
var Gallery = withMessageContentContext(themed((_temp$8 = _class$8 =
/*#__PURE__*/
function (_React$PureComponent) {
...
var DeliveredCircle = styled__default.View(_templateObject4$5(), function (_ref2) {
  var theme = _ref2.theme;
  return theme.colors.primary;
}, function (_ref3) {
  var theme = _ref3.theme;
...
var ReactionPicker = themed((_temp$a = _class$a =
/*#__PURE__*/
function (_React$PureComponent) {
...
}(React__default.PureComponent), _defineProperty(_class$a, "themePath", 'message.reactionPicker'), _temp$a));
...
var TextContainer = styled__default.View(_templateObject$e(), function (_ref) {
  ...
  return groupStyle.indexOf('left') !== -1 ? theme.message.text.borderRadiusS : theme.message.text.borderRadiusL;
}, function (_ref2) {
  var theme = _ref2.theme,
      groupStyle = _ref2.groupStyle;
  return groupStyle.indexOf('right') !== -1 ? theme.message.text.borderRadiusS : theme.message.text.borderRadiusL;
}, function (_ref3) {
  var theme = _ref3.theme,
      groupStyle = _ref3.groupStyle;
  return groupStyle === 'leftBottom' || groupStyle === 'leftMiddle' ? theme.message.text.borderRadiusS : theme.message.text.borderRadiusL;
}, function (_ref4) {
  var theme = _ref4.theme,
      groupStyle = _ref4.groupStyle;
  return groupStyle === 'rightBottom' || groupStyle === 'rightMiddle' ? theme.message.text.borderRadiusS : theme.message.text.borderRadiusL;
}, function (_ref5) {
  var alignment = _ref5.alignment;
  ...
  return alignment === 'left' ? theme.message.text.leftBorderWidth : theme.message.text.rightBorderWidth;
}, function (_ref7) {
  var theme = _ref7.theme,
      alignment = _ref7.alignment;
  return alignment === 'left' ? theme.message.text.leftBorderColor : theme.message.text.rightBorderColor;
}, function (_ref8) {
  var theme = _ref8.theme,
      alignment = _ref8.alignment,
      type = _ref8.type,
      status = _ref8.status;
  return alignment === 'left' || type === 'error' || status === 'failed' ? theme.colors.light : theme.colors.primary;
}, function (_ref9) {
  var theme = _ref9.theme;
  return theme.message.text.css;
});
var MessageTextContainer = function MessageTextContainer(props) {
  ...
  var textColor = isMyMessage(message) ? '#000' : '#fff';
  var textStyle = {
    text: {
      color: textColor
    }
  ...
  return React__default.createElement(React__default.Fragment, null, React__default.createElement(TextContainer, {
    ...
    type: message.type
  }, !MessageText ? renderText(message, textStyle) : React__default.createElement(MessageText, _extends({}, props, {
...
var Container$a = styled__default.TouchableOpacity(_templateObject$h(), function (_ref) {
  ...
  var alignment = _ref5.alignment,
      theme = _ref5.theme;
  return alignment === 'left' ? theme.message.text.borderRadiusS : theme.message.text.borderRadiusL;
}, function (_ref6) {
  var alignment = _ref6.alignment,
      theme = _ref6.theme;
  return alignment === 'left' ? theme.message.text.borderRadiusL : theme.message.text.borderRadiusS;
}, function (_ref7) {
  var theme = _ref7.theme;
  return theme.message.text.borderRadiusL;
}, function (_ref8) {
  var theme = _ref8.theme;
  return theme.message.text.borderRadiusL;
}, function (_ref9) {
...
var MessageContent = themed((_temp$b = _class$b =
/*#__PURE__*/
function (_React$PureComponent) {
  ...
  _createClass(MessageContent, [{
    ...
    value: function render() {
      ...
      }), message.type === 'error' ? React__default.createElement(FailedText, null, "ERROR \xB7 UNSENT") : null, message.status === 'failed' ? React__default.createElement(FailedText, null, "Message failed - try again") : null, React__default.createElement(MetaText, null, message.user.name), reactionsEnabled && message.latest_reactions && message.latest_reactions.length > 0 && React__default.createElement(ReactionList, {
        position: pos,
...
}(React__default.PureComponent), _defineProperty(_class$b, "themePath", 'message.content'), _defineProperty(_class$b, "propTypes", {
...
var Text = styled__default.Text(_templateObject4$9(), function (_ref5) {
  var theme = _ref5.theme;
...
var MessageSimple = themed((_temp$c = _class$c =
/*#__PURE__*/
function (_React$PureComponent) {
...
var Message = withKeyboardContext((_temp$d = _class$d =
/*#__PURE__*/
function (_React$Component) {
...
var MemberUpdateText = styled__default.Text(_templateObject4$a(), function (_ref4) {
  var theme = _ref4.theme;
...
var EventIndicator = function EventIndicator(_ref5) {
  ...
  if (event.type === 'member.added' || event.type === 'member.removed') {
    ...
    }), React__default.createElement(MemberUpdateTextContainer, null, React__default.createElement(MemberUpdateText, null, event.user.name, event.type === 'member.added' ? ' joined the chat' : ' was removed from the chat'), React__default.createElement(Date$1, null, Moment(event.received_at).format('hh:mm A'))));
  }
...
var Date$2 = styled__default.Text(_templateObject4$b(), function (_ref5) {
  var theme = _ref5.theme;
...
var DateSeparator = themed((_temp$e = _class$e =
/*#__PURE__*/
function (_React$PureComponent) {
...
}(React__default.PureComponent), _defineProperty(_class$e, "themePath", 'messageList.dateSeparator'), _temp$e));
...
var ListContainer = styled__default.FlatList(_templateObject$o(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageList.listContainer.css;
});
var ErrorNotificationText = styled__default.Text(_templateObject2$i(), function (_ref2) {
  var theme = _ref2.theme;
...
var MessageList = withChannelContext((_temp$f = _class$f =
/*#__PURE__*/
function (_PureComponent) {
  ...
  function MessageList(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleScroll", function (event) {
      ...
      if (!_this.props.threadList && removeNewMessageNotification) _this.props.markRead();
  ...
  _createClass(MessageList, [{
    ...
    value: function render() {
      ...
      if (this.props.messages && this.props.messages.length === 0 && !this.props.threadList) {
        return React__default.createElement(reactNative.View, {
          style: {
            flex: 1
          }
      ...
      }), React__default.createElement(TypingIndicatorContainer, null, this.props.TypingIndicator && showTypingIndicator && React__default.createElement(TypingIndicator, {
  ...
  return MessageList;
}(React.PureComponent), _defineProperty(_class$f, "propTypes", {
...
var TypingText = styled__default.Text(_templateObject$p(), function (_ref) {
  var theme = _ref.theme;
...
var Container$g = styled__default.View(_templateObject2$j());
var TypingIndicator = themed((_temp$g = _class$g =
/*#__PURE__*/
function (_React$PureComponent) {
...
}(React__default.PureComponent), _defineProperty(_class$g, "themePath", 'typingIndicator'), _temp$g));
...
var UploadProgressIndicator = themed((_temp$h = _class$h =
/*#__PURE__*/
function (_React$PureComponent) {
...
}(React__default.PureComponent), _defineProperty(_class$h, "themePath", 'messageInput.uploadProgressIndicator'), _defineProperty(_class$h, "propTypes", {
...
var Upload = styled__default.Image(_templateObject4$d(), function (_ref4) {
  var theme = _ref4.theme;
...
var ImageUploadPreview = themed((_temp$i = _class$i =
/*#__PURE__*/
function (_React$PureComponent) {
...
}(React__default.PureComponent), _defineProperty(_class$i, "themePath", 'messageInput.imageUploadPreview'), _defineProperty(_class$i, "propTypes", {
  /**
...
var InputBox = styled__default.TextInput(_templateObject$s(), function (_ref) {
  var theme = _ref.theme;
  return theme.messageInput.inputBox.css;
});
var AutoCompleteInput = styled.withTheme((_temp$j = _class$j =
/*#__PURE__*/
function (_React$PureComponent) {
...
}(React__default.PureComponent), _defineProperty(_class$j, "propTypes", {
...
var InputBoxContainer = styled__default.View(_templateObject2$m(), function (_ref4) {
  var theme = _ref4.theme;
...
var AttachButtonIcon = styled__default.Image(_templateObject4$e(), function (_ref6) {
  var theme = _ref6.theme;
  return theme.messageInput.attachButtonIcon.css;
});
var SendButton = styled__default.TouchableOpacity(_templateObject5$8(), function (_ref7) {
  var theme = _ref7.theme;
  return theme.messageInput.sendButton.css;
});
var SendButtonIcon = styled__default.Image(_templateObject6$3(), function (_ref8) {
  var theme = _ref8.theme;
...
var MessageInput = withKeyboardContext(withSuggestionsContext(withChannelContext(themed((_temp$k = _class$k =
/*#__PURE__*/
function (_PureComponent) {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return _this.props.client.updateMessage(_objectSpread$5({}, _this.props.editing, {
                text: _this.state.text
              }));
  ...
  _createClass(MessageInput, [{
    ...
    value: function render() {
      ...
      return React__default.createElement(React__default.Fragment, null, React__default.createElement(reactNative.View, {
        ...
        title: React__default.createElement(reactNative.View, {
          style: {
            flexDirection: 'row',
            justifyContent: 'space-between',
            alignItems: 'center',
        ...
        }, "Add a file"), React__default.createElement(IconSquare, {
          icon: img$m,
      ...
      }, this.props.editing ? React__default.createElement(SendButtonIcon, {
        source: img$h
  ...
  return MessageInput;
}(React.PureComponent), _defineProperty(_class$k, "themePath", 'messageInput'), _defineProperty(_class$k, "propTypes", {
  /**
...
var AttachmentActionSheetItem = function AttachmentActionSheetItem(_ref15) {
  ...
  }, React__default.createElement(IconSquare, {
    icon: icon
  }), React__default.createElement(reactNative.Text, {
    style: {
      marginLeft: 15
...
var Container$k = styled__default.TouchableOpacity(_templateObject$u(), function (_ref) {
  var theme = _ref.theme;
  return theme.channelPreview.container.css;
});
var Details = styled__default.View(_templateObject2$n(), function (_ref2) {
  var theme = _ref2.theme;
...
var Title$2 = styled__default.Text(_templateObject4$f(), function (_ref4) {
  var theme = _ref4.theme;
...
var ChannelPreviewMessenger = themed((_temp$l = _class$l =
/*#__PURE__*/
function (_PureComponent) {
...
}(React.PureComponent), _defineProperty(_class$l, "themePath", 'channelPreview'), _defineProperty(_class$l, "propTypes", {
...
var ChannelListMessenger = withChatContext((_temp$m = _class$m =
/*#__PURE__*/
function (_PureComponent) {
...
}), _defineProperty(_class$m, "defaultProps", {
...
var ChannelList = withChatContext((_temp$n = _class$n =
/*#__PURE__*/
function (_PureComponent) {
  ...
  return ChannelList;
}(React.PureComponent), _defineProperty(_class$n, "propTypes", {
...
var NewThread = styled__default.View(_templateObject$v(), function (_ref) {
  var theme = _ref.theme;
  return theme.thread.newThread.css;
});
var NewThreadText = styled__default.Text(_templateObject2$o(), function (_ref2) {
  var theme = _ref2.theme;
...
var Thread = withChannelContext(themed((_temp$o = _class$o =
/*#__PURE__*/
function (_React$PureComponent) {
  ...
  return Thread;
}(React__default.PureComponent), _defineProperty(_class$o, "themePath", 'thread'), _defineProperty(_class$o, "propTypes", {
...
function (_React$PureComponent2) {
  ...
  _createClass(ThreadInner, [{
    ...
    value: function render() {
      ...
      }, this.props)), React__default.createElement(NewThread, null, React__default.createElement(NewThreadText, null, "Start of a new thread")));
...
var Container$l = styled__default.View(_templateObject$w());
var Icon = styled__default.View(_templateObject2$p(), function (_ref) {
  var theme = _ref.theme;
...
var UnreadCount = styled__default.Text(_templateObject4$g(), function (_ref3) {
  var theme = _ref3.theme;
...
function (_React$Component) {
  ...
  _createClass(IconBadge, [{
    ...
    value: function render() {
      ...
      return React.createElement(Container$l, null, children, unread > 0 && React.createElement(Icon, null, React.createElement(IconInner, null, showNumber && React.createElement(UnreadCount, null, unread))));
    }
  }]);
...
function withChannelListMessengerFunctionality(WrappedListComponent) {
  var _class, _temp;

  return withChatContext((_temp = _class =
  /*#__PURE__*/
  function (_React$Component) {
    ...
    function _class() {
      ...
      _defineProperty(_assertThisInitialized(_this), "renderChannels", function () {
        ...
        return React__default.createElement(WrappedListComponent, _extends({
          data: _this.props.channels,
          onEndReached: _this.props.loadNextPage,
          onEndReachedThreshold: _this.props.loadMoreThreshold,
          ListEmptyComponent: _this.renderEmptyState,
    ...
    return _class;
  }(React__default.Component), _defineProperty(_class, "defaultProps", {
    Preview: ChannelPreviewMessenger,
    LoadingIndicator: LoadingIndicator,
    LoadingErrorIndicator: LoadingErrorIndicator,
    EmptyStateIndicator: EmptyStateIndicator,
...
exports.withChannelListMessengerFunctionality = withChannelListMessengerFunctionality;
